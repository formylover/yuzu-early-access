...
constexpr std::size_t CONSOLE_SIXAXIS_OFFSET = 0x3C200;
...
Controller_NPad::NPadControllerType Controller_NPad::MapSettingsTypeToNPad(
    ...
    case Settings::ControllerType::Pokeball:
        return NPadControllerType::Pokeball;
    default:
        UNREACHABLE();
        return NPadControllerType::ProController;
    }
...
void Controller_NPad::InitNewlyAddedController(std::size_t controller_idx) {
    ...
    case NPadControllerType::JoyRight:
        ...
        break;
    case NPadControllerType::GameCube:
        controller.joy_styles.gamecube.Assign(1);
...
void Controller_NPad::RequestPadStateUpdate(u32 npad_id) {
    ...
    auto& trigger_state = npad_trigger_states[controller_idx];
    ...
    if (controller_type == NPadControllerType::GameCube) {
        // Fill with nothing until analog triggers can be mapped
        trigger_state.l_analog = 0;
        trigger_state.r_analog = 0;
    }
}
...
void Controller_NPad::OnUpdate(const Core::Timing::CoreTiming& core_timing, u8* data,
    ...
    for (std::size_t i = 0; i < shared_memory_entries.size(); ++i) {
        ...
        for (auto* analog_trigger : controller_triggers) {
            analog_trigger->common.entry_count = 16;
            analog_trigger->common.total_entry_count = 17;

            const auto& last_entry =
                analog_trigger->trigger[analog_trigger->common.last_entry_index];

            analog_trigger->common.timestamp = core_timing.GetCPUTicks();
            analog_trigger->common.last_entry_index =
                (analog_trigger->common.last_entry_index + 1) % 17;

            auto& cur_entry = analog_trigger->trigger[analog_trigger->common.last_entry_index];
        ...
        auto& trigger_entry =
            npad.gc_trigger_states.trigger[npad.gc_trigger_states.common.last_entry_index];
